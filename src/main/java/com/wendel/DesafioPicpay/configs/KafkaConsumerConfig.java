...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, UserResponseDTO> emailConsumerFactory() {
		...
		props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.wendel.DesafioPicpay.dtos.UserResponseDTO");
		return new DefaultKafkaConsumerFactory<>(props);
	}
	
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, UserResponseDTO> emailKafkaListenerContainerFactory() {
